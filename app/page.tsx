...
// 아래 섹션들은 초기 렌더링 속도 향상을 위해 지연 로딩(Lazy Loading) 처리합니다.
const ConceptSection = dynamic(() => import('../components/ConceptSection'), { ssr: true });
const ComparisonSection = dynamic(() => import('../components/ComparisonSection'), { ssr: true });
const TargetSection = dynamic(() => import('../components/TargetSection'), { ssr: true });
...
const InstallmentVsRentSection = dynamic(() => import('../components/InstallmentVsRentSection'), { ssr: true });
